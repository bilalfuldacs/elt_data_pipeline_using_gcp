...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='1million-record',  # Replace with your bucket name
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='aerobic-cyclist-450611-h8.staging_dataset.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV', 
